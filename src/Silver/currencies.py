...
class Currencies():
    def __init__(self):
        ...
        self.bronze_path = "tu_mai/BronzeLayer/CurrenciesData"
        self.silver_path = "tu_mai/SilverLayer"
        pass

    def get_bronze_data(self, gcs_path):
        """ Get Currencies raw data into a Dataframe
        Return:
            Dataframe about Currencies data
        """
    ...
    def write_gcs(self, df):
        ...
        gcs_path = f"gs://{self.bucket_name}/{self.silver_path}/Currencies"
        # Write polar df
        df.write_delta(gcs_path, mode="append")
        print('WRITE CURRENCIES DATA SUCESSFULLY!')

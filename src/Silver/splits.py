...
class Splits():
    def __init__(self):
        ...
        self.bronze_path = "tu_mai/BronzeLayer/SplitsData"
        self.silver_path = "tu_mai/SilverLayer"
        pass

    def get_bronze_data(self, gcs_path):
        """ Get Splits raw data into a Dataframe
        Return:
            Dataframe about Splits data
        """
    ...
    def write_gcs(self, df):
        ...
        gcs_path = f"gs://{self.bucket_name}/{self.silver_path}/Splits"
        # Write polar df
        df.write_delta(gcs_path, mode="append")
        print('WRITE SPLITS DATA SUCESSFULLY!')

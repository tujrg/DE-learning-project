...
class Dividends():
    def __init__(self):
        ...
        self.bronze_path = "tu_mai/BronzeLayer/DividendsData"
        self.silver_path = "tu_mai/SilverLayer"
        pass

    def get_bronze_data(self, gcs_path):
        """ Get Dividends raw data into a Dataframe
        Return:
            Dataframe about Dividends data
        """
    ...
    def write_gcs(self, df):
        ...
        gcs_path = f"gs://{self.bucket_name}/{self.silver_path}/Dividends"
        # Write polar df
        df.write_delta(gcs_path, mode="append")
        print('WRITE DIVIDENS DATA SUCESSFULLY!')
